...
class WebCrawler:
            ...
            for a_tag in soup.find_all('a', href=True):
                try:
                    ...
                    if not absolute_url.startswith('http://'):
                        absolute_url = f'http://{absolute_url}'
    ...
    def crawl_url(self, url, depth, writer, start_domain):
        if not url.startswith('http://'):
            url = f'http://{url}'
            ...
            try:
                ...
                if target_url not in self.visited_urls:
                    ...
                    if target_response:
                        ...
                        self.crawl_url(target_url, depth + 1, writer, start_domain)
    ...
    def crawl(self):
        ...
        with open(self.output_file, 'a', newline='', encoding='utf-8') as csvfile:
            ...
            for domain in domains:
                ...
                start_domain = urlparse(domain).netloc
                
                try:
                    self.crawl_url(domain, 1, writer, start_domain)
                except Exception as e:
...
output_file = 'crawl_results_http_only.csv'
html_dir = 'html_pages__http_only'  
